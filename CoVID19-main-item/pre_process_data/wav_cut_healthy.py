...
filename = '/private/Coswara-Data/healthy_quality12_id_scp/healthy_quality12_{}_path.scp'.format(audio_class)
try:
        ...
        try:
            ...
            with wave.open(file_path, 'rb') as f:
                ...
                while step_num * (haha + 1) <= nframes:
                    ...
                    target_part = parts[-2]
                    output_dir = '/private/Coswara-Data/cut_5s_data/healthy_data/{}'.format(audio_class)
